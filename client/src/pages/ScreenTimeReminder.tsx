      ...
      >
        ...
        <div className="flex items-end gap-4">
          <motion.img
            src={ASSETS.penguin}
            alt="Sleepy Penguin"
            className="w-28 h-28 object-contain drop-shadow-md opacity-80"
        ...
        <div className="text-center max-w-md">
          <h2 className="game-title text-3xl text-game-lavender mb-4">
            Time for a Break!
          </h2>
        ...
        {/* Continue button (smaller, less prominent) */}
        <motion.button
          className="rounded-2xl font-bold text-base px-8 py-4 transition-all duration-200 shadow-md hover:shadow-lg bg-game-lavender/50 text-foreground/60 mt-4"
